...
public class SortsHWProblem10 
{
   ...
   static int numOfComps = 0;             // counts number of comparisons
   ...
   // values[startIndex]..values[endIndex].
   {
      ...
      for (int index = startIndex + 1; index <= endIndex; index++){
         numOfComps++;        // increment number of comparisons                                                            
...
//       System.out.println();
      ...
      SortsHWProblem10.numOfSwaps = 0;
      SortsHWProblem10.numOfComps = 0;
      selectionSort();
      System.out.println("----------Selection Sort----------");
      System.out.println("Number of Swaps: " + numOfSwaps);
      System.out.println("Number of Comps: " + numOfComps);
