//Alexander Kim
//CIS 112 ONLN2 Summer 2019 Week 10 Homework
//Problem 1
//Jason Wertz

/*************************************************************
1a. Create a variable for the class called numOfSwaps
    that keeps track of the number of swaps, and increment
    that variable within the swap method. This way, every
    time swap gets called, the variable is incremented and
    keeps track of the number of swaps. Then just print or
    return the value in the main after running a sort method.
**************************************************************/


/*******************************************************
1b -- Implementation. Changes found on lines 27 and 51.
********************************************************/

import java.util.*;
import java.text.DecimalFormat;

public class SortsHWProblem1 
{
   static final int SIZE = 50;            // size of array to be sorted
   static int[] values = new int[SIZE];   // values to be sorted
   static int numOfSwaps = 0;             // counts number of swaps
   ...
   {
      numOfSwaps++;        // increment number of swaps each time method is called. 
   ...
   public static void main(String[] args)
   {
      ...
      selectionSort();        // Running selection sort for problem 1c.
      // bubbleSort();
      // shortBubble();
      // insertionSort();
      // mergeSort(0, SIZE - 1);
...
/*******************************************************
1c -- Compile and run the program. Check console output.
********************************************************/
